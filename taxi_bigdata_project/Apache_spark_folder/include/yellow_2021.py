...
# ------------------------------
def process_to_parquet(year=2021):
...
# ------------------------------
def transform_taxi_data(input_path, year=2021):
...
def load_to_snowflake(parquet_path, snowflake_conn_id='snowflakes_con'):
    ...
    table_name = f"{database}.{schema}.YELLOW_TRIP_2021_DATA"
